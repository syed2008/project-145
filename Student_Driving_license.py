...
label_vehicle_tag = canvas.create_text(155,180, font=('Times', '12', 'bold') ,text="Authorisation to drive the following vehicles :")
...
button1 = Button(root, text = "Show my ID Card", command=myli)
